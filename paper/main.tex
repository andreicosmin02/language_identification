...
Third, fastText is particularly attractive when a strong performance-speed trade-off is needed. It is not the absolute best model on average, but it performs best or near-best on the 3-word clean and noisy conditions in this experiment while remaining much faster than the SVM.
